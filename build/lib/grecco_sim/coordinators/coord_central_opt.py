...
class CentralOptimizationCoordinator(coord_interface.CoordinatorInterface):
    ...
    def get_signals(self, futures: dict[str, type_defs.LocalFuture]) -> dict[str, sig_types.SignalType]:
        ...
        ret_inflex = {sys_id: sig_types.DirectControlSignal(np.zeros(current_horizon)) for sys_id in inflex_futures}
