...
class CoordinatorSecondOrder(coord_interface.CoordinatorInterface):
    ...
    def __init_iteration(self, flex_futures: Dict[str, type_defs.LocalFuture], inflex_sum: np.ndarray):
    ...
    def get_signals(
        ...
        yk_static = handle_static_agent_problem(
            sig_types.SecondOrderSignal(mul_lambda=self.lam, res_power_set=self.ref_power_grid[self.SLACK_AGENT]),
            self.opt_p.rho,
            self.grid_p.p_lim,
            inflex_sum,
