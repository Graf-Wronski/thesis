...
from grecco_sim.coordinators import coord_interface, coord_second_order
...
class CoordinatorADMM(coord_interface.CoordinatorInterface):
    ...
    def get_signals(
        ...
        yk_slack = coord_second_order.handle_static_agent_problem(
            sig_types.SecondOrderSignal(self.ref_power_grid[self.SLACK_AGENT], self.lam[self.SLACK_AGENT]),
            self.opt_pars.rho,
